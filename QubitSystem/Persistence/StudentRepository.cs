...
namespace QubitSystem.Persistence
{
    public class StudentRepository : GenericRepository<Student>, IStudentRepository
    {
        ...
        public StudentRepository(DataDbContext context, IMapper mapper) : base(context)
        {
            this.mapper = mapper;
        }
        ...
        public async Task<StudentDetailsDto> GetStudentFullDetails(string Id)
        {
        ...
        public async Task<StudentInputDto> GetStudentFullInputDetails(string Id)
        {
            var student = await context.Students.Include(i => i.Courses).FirstOrDefaultAsync(x => x.Id == Id);
